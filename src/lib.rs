...
impl Config {
    pub fn new() -> Result<Config, String> {
        let matches = App::new(APP_NAME)
            ...
            .about("This program a gadget which helps you use FFmpeg to record your screen on Linux. The video record can be saved as a file, or be streamed via RTMP protocol. Your FFmpeg needs to enable libfdk-aac and libx264 libraries.")
            .arg(Arg::with_name("w")
                .short("w")
                .long("window")
            ...
            .arg(Arg::with_name("nn")
                .short("n")
                .long("no-normalize")
                .help("Does not pad the video size with black borders to the ratio of 16:9.")
            )
            .arg(Arg::with_name("o")
                .short("o")
                .long("output")
